...
#define CUST_EINT_FPC_NUM              198
#define CUST_EINT_FPC_DEBOUNCE_CN      0
#define CUST_EINT_FPC_TYPE							CUST_EINTF_TRIGGER_RISING
#define CUST_EINT_FPC_DEBOUNCE_EN      CUST_EINT_DEBOUNCE_DISABLE

#define CUST_EINT_GSE_1_NUM              201
