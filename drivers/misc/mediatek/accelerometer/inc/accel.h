...
#define ZTE_ACCEL_CHOICE_NODO                (0)
#define ZTE_ACCEL_CHOICE_KXCNL               (1)
#define ZTE_ACCEL_CHOICE_LIS3DSH             (2)
#define ZTE_ACCEL_CHOICE_KXTIK1004           (3)
...
struct acc_control_path
{
	...
	int (*pedo_enable)(int en);//zhangxin
...
extern int zte_get_accelchipidx(void);
