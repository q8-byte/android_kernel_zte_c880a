 ...
 */
//lichengmin begin
#ifndef __EPL_CUST_ALSPS_H__
#define __EPL_CUST_ALSPS_H__
...
struct epl_alsps_hw {
	...
	unsigned int  ps_threshold_high ;// ;ps_threshold_high ps_high_thd_val
	unsigned int   ps_threshold_low ;//;ps_threshold_low ps_low_thd_val
	unsigned int    als_window_loss;                /*!< the window loss  */
};

extern struct epl_alsps_hw* get_cust_alsps_hw_epl2182(void);
#endif 
//lichengmin end