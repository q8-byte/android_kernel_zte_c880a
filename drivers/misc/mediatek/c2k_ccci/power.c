...
extern void c2k_modem_power_off_platform(int timeout);
...
void c2k_power_off_modem(int timeout)
{
	unsigned long flags;
	...
	modem_pre_stop();
	c2k_wake_host(0);
    c2k_modem_power_off_platform(timeout);
