...
#include <mach/mt_gpio.h>
#include <linux/wakelock.h>//add by tony
...
#endif
/*
#define FPC1020_INT_IRQNO      CUST_EINT_FTP_IRQ_NUM
#define FPC1020_IRQ_GPIO        GPIO_FTP_EINT_PIN
#define FPC1020_RESET_GPIO      GPIO_FTP_RST_PIN
*/
...
#define FPC1020_SPI_DEV_NAME               "spidev"   
...
typedef struct fpc1020_diag {
	...
	u8 finger_up;	/* RO*/
	u8 finger_up_down;	/* RO*/  //add  for pv fastmmi
	u8 switch_to_input;//add by tony
	u8 go_to_deep_sleep;//add by tony
} fpc1020_diag_t;
