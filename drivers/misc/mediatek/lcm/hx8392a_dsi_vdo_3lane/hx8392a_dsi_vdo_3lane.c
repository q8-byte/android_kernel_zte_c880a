...
{0xBA,0x06, {0x63, 0x03, 0x68, 0x6B, 0xB2, 0xC0}},
	...
	// Set Power
{ 0xB1,0x0A,{0x54,0x12,0x72,0x09,0x33,0x54,0x71,0x31,0x70,0x2F}},

	// Set Display
{ 0xB2, 0x06,{0x00, 0x80, 0x64, 0x0E, 0x0D, 0x2F}},

	// Set CYC
{ 0xB4,0x1E,{0x76,0x77,0x76,0x77,0x76,0x77,0x06,0x06,0x7F,0x96,0x00,0x3F,0x6C,0x6D,0x6C,0x6D,0x6C,0x6D,0x01,0x01,0xFF,0x3F,0x03,0xFC,0x81,0x81,0x81,0x81,0x08,0x09}},

	// Set VCOM
//{ 0xB6,0x02,{0x73, 0x73}},	//default 0x46

	// Set D3
{ 0xD3,0x21,{0x00,0x00,0x01,0x01,0x40,0x07,0x10,0x00,0x08,0x10,0x08,0x00,0x08,0x54,0x15,0x0E,0x05,0x0E,0x02,0x15,0x06,0x05,0x06,0x47,0x44,0x0A,0x0A,0x4B,0x10,0x07,0x07,0x0E,0x40}},

	// Set GIP
{ 0xD5,0x2C,{0x1A,0x1A,0x1B,0x1B,0x00,0x01,0x02,0x03,0x04,0x05,0x06,0x07,0x08,0x09,0x0A,0x0B,0x24,0x25,0x18,0x18,0x26,0x27,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x20,0x21,0x18,0x18,0x18,0x18}},

	// Set D6
{ 0xD6,0x2C,{0x1A,0x1A,0x1B,0x1B,0x0B,0x0A,0x09,0x08,0x07,0x06,0x05,0x04,0x03,0x02,0x01,0x00,0x21,0x20,0x18,0x18,0x27,0x26,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x25,0x24,0x18,0x18,0x18,0x18}},

	// Set Gamma
{ 0xE0,0x3A,{0x00,0x0C,0x19,0x20,0x23,0x26,0x29,0x28,0x51,0x61,0x70,0x6F,0x76,0x86,0x89,0x8D,0x99,0x9A,0x95,0xA1,0xB0,0x57,0x55,0x58,0x5C,0x5E,0x64,0x6B,0x7F,0x00,0x0C,0x18,0x20,0x23,0x26,0x29,0x28,0x51,0x61,0x70,0x6F,0x76,0x86,0x89,0x8D,0x99,0x9A,0x95,0xA1,0xB0,0x57,0x55,0x58,0x5C,0x5E,0x64,0x6B,0x7F}},
...
{ 0xBF,0x07,{0x40, 0x81, 0x50, 0x00, 0x1A, 0xFC, 0x01}},
 {0x11,	1,		{0x00}},
 {REGFLAG_DELAY, 200, {}},		
 {0x29,	1,		{0x00}},	
  {REGFLAG_DELAY, 10, {}},
...
static struct LCM_setting_table lcm_sleep_in_setting[] = {
	//test begin
		...
		{0xB0, 0x04,{0x00, 0x11, 0x78,0x0F}},
		{REGFLAG_DELAY, 20, {}},
		{0xB0, 0x04,{0x00, 0x11, 0x68,0x0F}},
		{REGFLAG_DELAY, 20, {}},
		{0xB0, 0x04,{0x00, 0x11, 0x60,0x0F}},
		{REGFLAG_DELAY, 20, {}},
		{0xB0, 0x04,{0x00, 0x11, 0x20,0x0F}},
		{REGFLAG_DELAY, 20, {}},
		{0xB0, 0x04,{0x00, 0x11, 0x00,0x0F}},
		{REGFLAG_DELAY, 20, {}},
		{0xB0, 0x04,{0x00, 0x10, 0x01,0x0F}},
		{REGFLAG_DELAY, 20, {}},
	//test end
...
static void lcm_get_params(LCM_PARAMS *params)
{
		...
		params->dsi.vertical_backporch				       = 12; //20;  //14  
		params->dsi.vertical_frontporch				       = 15; //14;  //16  
		params->dsi.vertical_active_line				       = FRAME_HEIGHT;     
		params->dsi.horizontal_sync_active				= 15; // 30;//60;   //4
		params->dsi.horizontal_backporch				= 20; //60;//;  //60  
		params->dsi.horizontal_frontporch				= 20; // 60;//100;    //60
		//params->dsi.horizontal_blanking_pixel				= 60;   
		params->dsi.horizontal_active_pixel				= FRAME_WIDTH;  
		params->dsi.HS_TRAIL = 12;

		params->dsi.PLL_CLOCK = 180;   //245
...
#ifdef BUILD_LK
	printf("%s, yassy hx8394c , pin_lcd_id0= %d \n", __func__, pin_lcd_id0);
#else
	printk("%s, yassy hx8394c, pin_lcd_id0= %d \n", __func__, pin_lcd_id0);
#endif
	return (pin_lcd_id0 == 0)?1:0; 
}
