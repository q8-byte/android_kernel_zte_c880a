...
void red_blink_add(void)
{
   ...
   pmic_set_register_value(PMIC_RG_DRV_ISINK1_CK_PDN,0x0);//  mt6325_upmu_set_rg_drv_isink0_ck_pdn(0); 
   pmic_set_register_value(PMIC_RG_DRV_ISINK1_CK_CKSEL,0x0);// mt6325_upmu_set_rg_drv_isink0_ck_cksel(0); 
   pmic_set_register_value(PMIC_ISINK_CH1_MODE,PMIC_PWM_1);// mt6325_upmu_set_isink_ch0_mode(PMIC_PWM_1); 
   pmic_set_register_value(PMIC_ISINK_CH1_STEP,ISINK_1);// mt6325_upmu_set_isink_ch0_step(ISINK_3); 
   pmic_set_register_value(PMIC_ISINK_BREATH1_TR1_SEL,0x04); //mt6325_upmu_set_isink_breath0_tr1_sel(0x04); 
   pmic_set_register_value(PMIC_ISINK_BREATH1_TR2_SEL,0x04);//mt6325_upmu_set_isink_breath0_tr2_sel(0x04); 
   pmic_set_register_value(PMIC_ISINK_BREATH1_TF1_SEL,0x04);//mt6325_upmu_set_isink_breath0_tf1_sel(0x04); 
   pmic_set_register_value(PMIC_ISINK_BREATH1_TF2_SEL,0x04);//mt6325_upmu_set_isink_breath0_tf2_sel(0x04); 
   pmic_set_register_value(PMIC_ISINK_BREATH1_TON_SEL,0x02);//mt6325_upmu_set_isink_breath0_ton_sel(0x02); 
   pmic_set_register_value(PMIC_ISINK_BREATH1_TOFF_SEL,0X03);// mt6325_upmu_set_isink_breath0_toff_sel(0x03); 
   pmic_set_register_value(PMIC_ISINK_DIM1_DUTY,15);// mt6325_upmu_set_isink_dim0_duty(15); 
   pmic_set_register_value(PMIC_ISINK_DIM1_FSEL,11);//mt6325_upmu_set_isink_dim0_fsel(ISINK_1KHZ); 
   pmic_set_register_value(PMIC_ISINK_CH1_EN,NLED_ON);//mt6325_upmu_set_isink_ch0_en(NLED_ON);
