...
const kal_uint32 CS_VTH[]=
{
 ...
 enum {
	 POWER_SUPPLY_STATUS_CHARGING=0,
...
static void hw_bc11_dump_register(void)
{
	...
	kal_uint32 reg_num = MT6328_CHR_CON18;
	kal_uint32 i = 0;

	for(i=reg_num ; i<=MT6328_CHR_CON19 ; i+=2)
	{
 ...
 static void hw_bc11_init(void)
 {
	 ...
	 //RG_BC11_BIAS_EN=1	
	pmic_set_register_value(PMIC_RG_BC11_BIAS_EN,0x1); //upmu_set_rg_bc11_bias_en(0x1);
	 //RG_BC11_VSRC_EN[1:0]=00
	pmic_set_register_value(PMIC_RG_BC11_VSRC_EN,0x0); //upmu_set_rg_bc11_vsrc_en(0x0);
	 //RG_BC11_VREF_VTH = [1:0]=00
	pmic_set_register_value(PMIC_RG_BC11_VREF_VTH,0x0);  //upmu_set_rg_bc11_vref_vth(0x0);
	 //RG_BC11_CMP_EN[1.0] = 00
	pmic_set_register_value(PMIC_RG_BC11_CMP_EN,0x0); // upmu_set_rg_bc11_cmp_en(0x0);
	 //RG_BC11_IPU_EN[1.0] = 00
	 pmic_set_register_value(PMIC_RG_BC11_IPU_EN,0x0); //upmu_set_rg_bc11_ipu_en(0x0);
	 //RG_BC11_IPD_EN[1.0] = 00
	 pmic_set_register_value(PMIC_RG_BC11_IPD_EN,0x0); //upmu_set_rg_bc11_ipd_en(0x0);
	 //BC11_RST=1
	 pmic_set_register_value(PMIC_RG_BC11_RST,0x1); //upmu_set_rg_bc11_rst(0x1);
	 //BC11_BB_CTRL=1
	 pmic_set_register_value(PMIC_RG_BC11_BB_CTRL,0x0); //upmu_set_rg_bc11_bb_ctrl(0x1);
 ...
 static U32 hw_bc11_DCD(void)
 {
	 ...
	 pmic_set_register_value(PMIC_RG_BC11_IPU_EN,0x2);//upmu_set_rg_bc11_ipu_en(0x2);
	 //RG_BC11_IPD_EN[1.0] = 01
	  pmic_set_register_value(PMIC_RG_BC11_IPD_EN,0x1); //upmu_set_rg_bc11_ipd_en(0x1);
	 //RG_BC11_VREF_VTH = [1:0]=01
	pmic_set_register_value(PMIC_RG_BC11_VREF_VTH,0x1); // upmu_set_rg_bc11_vref_vth(0x1);
	 //RG_BC11_CMP_EN[1.0] = 10
	pmic_set_register_value(PMIC_RG_BC11_CMP_EN,0x2);// upmu_set_rg_bc11_cmp_en(0x2);
 ...
 static U32 hw_bc11_stepA1(void)
 {
	...
	pmic_set_register_value(PMIC_RG_BC11_VREF_VTH,0x2);//upmu_set_rg_bc11_vref_vth(0x2);
	//RG_BC11_CMP_EN[1.0] = 10
	pmic_set_register_value(PMIC_RG_BC11_CMP_EN,0x2);// upmu_set_rg_bc11_cmp_en(0x2);
	...
	wChargerAvail = pmic_get_register_value(PMIC_RGS_BC11_CMP_OUT);//wChargerAvail = upmu_get_rgs_bc11_cmp_out();
 ...
 static U32 hw_bc11_stepB1(void)
 {
	...
	pmic_set_register_value(PMIC_RG_BC11_CMP_EN,0x1);//upmu_set_rg_bc11_cmp_en(0x1);
 ...
 static U32 hw_bc11_stepC1(void)
 {
	...
	//RG_BC11_IPU_EN[1.0] = 01
	pmic_set_register_value(PMIC_RG_BC11_IPU_EN,0x1);//upmu_set_rg_bc11_ipu_en(0x1);
	//RG_BC11_VREF_VTH = [1:0]=10
	pmic_set_register_value(PMIC_RG_BC11_VREF_VTH,0x2);//upmu_set_rg_bc11_vref_vth(0x2);
	//RG_BC11_CMP_EN[1.0] = 01
	pmic_set_register_value(PMIC_RG_BC11_CMP_EN,0x1);//upmu_set_rg_bc11_cmp_en(0x1);
 ...
 static U32 hw_bc11_stepA2(void)
 {
	...
	pmic_set_register_value(PMIC_RG_BC11_VSRC_EN,0x2); //upmu_set_rg_bc11_vsrc_en(0x2);
	//RG_BC11_IPD_EN[1:0] = 01
	pmic_set_register_value(PMIC_RG_BC11_IPD_EN,0x1);//upmu_set_rg_bc11_ipd_en(0x1);
	//RG_BC11_VREF_VTH = [1:0]=00
	pmic_set_register_value(PMIC_RG_BC11_VREF_VTH,0x0);//upmu_set_rg_bc11_vref_vth(0x0);
 ...
 static void hw_bc11_done(void)
 {
	...
	pmic_set_register_value(PMIC_RG_BC11_IPD_EN,0x0);//upmu_set_rg_bc11_ipd_en(0x0);
	//RG_BC11_BIAS_EN=0
	pmic_set_register_value(PMIC_RG_BC11_BIAS_EN,0x0); //upmu_set_rg_bc11_bias_en(0x0); 
 ...
 static kal_uint32 charging_hw_init(void *data)
 {
	...
	status = max77819_charger_hw_init(data);      
 	return status;
 }
 ...
 static kal_uint32 charging_reset_watch_dog_timer(void *data)
 {
  ...
  static kal_uint32 charging_set_hv_threshold(void *data)
  {
	...
	pmic_set_register_value(PMIC_RG_VCDT_HV_VTH,register_value);// upmu_set_rg_vcdt_hv_vth(register_value);
  ...
  static kal_uint32 charging_get_hv_status(void *data)
  {
	  ...
	  *(kal_bool*)(data) = pmic_get_register_value(PMIC_RGS_VCDT_HV_DET);//  *(kal_bool*)(data) = upmu_get_rgs_vcdt_hv_det();
 ...
 static kal_uint32 charging_get_battery_status(void *data)
 {
 	  ...
 	  pmic_set_register_value(PMIC_BATON_TDET_EN,0x1); //upmu_set_baton_tdet_en(1);	
	  pmic_set_register_value(PMIC_RG_BATON_EN,0x1); //upmu_set_rg_baton_en(1);
	 *(kal_bool*)(data) = pmic_get_register_value(PMIC_RGS_BATON_UNDET);// *(kal_bool*)(data) = upmu_get_rgs_baton_undet();
 ...
 static kal_uint32 charging_get_charger_det_status(void *data)
 {
	   ...
	   *(kal_bool*)(data) = pmic_get_register_value(PMIC_RGS_CHRDET);//*(kal_bool*)(data) = upmu_get_rgs_chrdet();
