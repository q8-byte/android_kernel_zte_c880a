...
#ifdef CONFIG_OF_QXL   //CONFIG_OF do not work 
...
#define SPK_WARM_UP_TIME        (25) //unit is ms
...
#ifndef CONFIG_MTK_SPEAKER
        printk("Ext_Speaker_Amp_Change ON set GPIO \n");
        mt_set_gpio_mode(GPIO_SPK_AMP_EN, GPIO_MODE_00); //GPIO117: DPI_D3, mode 0
        mt_set_gpio_pull_enable(GPIO_SPK_AMP_EN, GPIO_PULL_ENABLE);
        mt_set_gpio_dir(GPIO_SPK_AMP_EN, GPIO_DIR_OUT); // output
        mt_set_gpio_out(GPIO_SPK_AMP_EN, GPIO_OUT_ZERO); // low disable
        udelay(1000);
        mt_set_gpio_dir(GPIO_SPK_AMP_EN, GPIO_DIR_OUT); // output
    ...
    else
    {
        ...
        //mt_set_gpio_mode(GPIO_SPK_AMP_EN, GPIO_MODE_00); //GPIO117: DPI_D3, mode 0
        mt_set_gpio_dir(GPIO_SPK_AMP_EN, GPIO_DIR_OUT); // output
        mt_set_gpio_out(GPIO_SPK_AMP_EN, GPIO_OUT_ZERO); // low disbale
        udelay(500);
#endif
        printk("Ext_Speaker_Amp_Change OFF- \n");
    }
